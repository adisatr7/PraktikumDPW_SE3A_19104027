<?php
    ...
    $sql_mahasiswa = "SELECT * FROM data WHERE id=".$_GET['id'];
...
<body>
    <div class="container">
        <h1 class="text-center mt-5 mb-5">Student Data</h1>
        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <a class="float-right ml-3 text-danger"
                                   href="delete_message.php?id=<?php echo $dt['id'] ?>" type="button"
                                   class="close">
                                    <span class="fa fa-trash"></span>
                                </a>

                                <a class="float-right ml-3 text_success"
                                    href="update_form.php?id=<?php echo $dt['id'] ?>" type="button"
                                    class="close">
