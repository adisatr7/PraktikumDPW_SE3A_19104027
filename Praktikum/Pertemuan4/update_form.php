                	...
                	<div class="form-group"> 
                		...
                		<select name="kelas" class="form-control" required> 
                			...
                			<?php foreach($kelas as $kl) : ?> 
                				<option value="<?= $kl; ?>" <?= ($kl == $view['kelas']) ? 'selected' : ''; ?>><?= $kl; ?>
                				</option> 
                				<?php endforeach; ?> 
                			</select> 
                		</div> 
                		...
                		<a href="index.php" class="btn btn-warning btn-block">Kembali
                		</a> 
                </form>
            </div>
                ...
                <div class="card mb-2">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <a class="float-right ml-3 text-danger" href="delete_data.php?id=<?php echo $dt['id'] ?>" type="button" class="close">
                                    <span class="fa fa-trash"></span>
                                </a>
                                <a class="float-right ml-3 text-succes" href="update_form.php?id=<?php echo $dt['id'] ?>" type="button" class="close">
